...
#Add for full kernel
ifeq ($(AGING_DEBUG_MASK),f)
OPLUS_FULL_KERNEL_DEBUG := true
endif

export OPLUS_AGING_TEST OPLUS_KASAN_TEST OPLUS_KMEMLEAK_TEST OPLUS_SLUB_TEST OPLUS_PAGEOWNER_TEST OPLUS_FULL_KERNEL_DEBUG
#endif
