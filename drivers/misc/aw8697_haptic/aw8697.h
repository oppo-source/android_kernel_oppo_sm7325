...
struct aw8697 {
    ...
    struct work_struct short_vibrator_work;
...
//add for play_go veg enable time at last 2ms
    ktime_t current_time, pre_enter_time;


//add for cancel repeat call
    bool vib_stop_flag;
...
#define AW8697_HAPTIC_VMAX_LEVEL_MAX        2400
